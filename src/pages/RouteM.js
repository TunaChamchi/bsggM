...
class RouteM extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            type:["단검","양손검","도끼","쌍검","권총","돌격소총","저격총","레이피어","창","망치","배트","투척","암기","활","석궁","글러브","톤파","기타","쌍절곤","채찍","카메라"],
            start:["단검","양손검","도끼","권총","돌격소총","저격총","레이피어","창","망치","배트","투척","암기","활","석궁","글러브","톤파","기타","쌍절곤","채찍","카메라"],
            selectType: '',
            selectViewList: [],
            ...
            startWeapon:{'단검':101104,'양손검':102101,'도끼':105103,'권총':116101,'돌격소총':117101,'저격총':118101,'레이피어':120101,'창':107101,
                '망치':104101,'배트':108102,'투척':112105,'암기':113101,'활':114101,'석궁':115101,'글러브':110102,'톤파':108103,'기타':121101,'쌍절곤':119101,'채찍':109101,'카메라':122101},
            mapSrc: {},
            routeList: [],
            _select:{},
